...
if not Success then
    warn("\nMetheus Library - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end
...
local Metheus = Instance.new("ScreenGui")
Metheus.Name = "Metheus"
if syn then
    syn.protect_gui(Metheus)
    Metheus.Parent = game.CoreGui
else
    Metheus.Parent = gethui() or game.CoreGui
end

if gethui then
    for _, Interface in ipairs(gethui():GetChildren()) do
        if Interface.Name == Metheus.Name and Interface ~= Metheus then
            Interface:Destroy()
        end
    end
else
...
function MetheusLib:IsRunning()
    if gethui then
        return Metheus.Parent == gethui()
    else
        return Metheus.Parent == game:GetService("CoreGui")
    end
end

local function AddConnection(Signal, Function)
    if (not MetheusLib:IsRunning()) then
        return
    end
    local SignalConnect = Signal:Connect(Function)
    table.insert(MetheusLib.Connections, SignalConnect)
    return SignalConnect
end

task.spawn(
    function()
        while (MetheusLib:IsRunning()) do
            wait()
        end

        for _, Connection in next, MetheusLib.Connections do
...
local function CreateElement(ElementName, ElementFunction)
    MetheusLib.Elements[ElementName] = function(...)
        return ElementFunction(...)
    end
end

local function MakeElement(ElementName, ...)
    local NewElement = MetheusLib.Elements[ElementName](...)
    return NewElement
end
...
local function AddThemeObject(Object, Type)
    if not MetheusLib.ThemeObjects[Type] then
        MetheusLib.ThemeObjects[Type] = {}
    end
    table.insert(MetheusLib.ThemeObjects[Type], Object)
    Object[ReturnProperty(Object)] = MetheusLib.Themes[MetheusLib.SelectedTheme][Type]
    return Object
end

local function SetTheme()
    for Name, Type in pairs(MetheusLib.ThemeObjects) do
        for _, Object in pairs(Type) do
            Object[ReturnProperty(Object)] = MetheusLib.Themes[MetheusLib.SelectedTheme][Name]
        end
    end
end
...
local function LoadCfg(Config)
    ...
    table.foreach(
        Data,
        function(a, b)
            if MetheusLib.Flags[a] then
                spawn(
                    function()
                        if MetheusLib.Flags[a].Type == "Colorpicker" then
                            MetheusLib.Flags[a]:Set(UnpackColor(b))
                        else
                            MetheusLib.Flags[a]:Set(b)
                        end
                    end
                )
            else
                warn("Metheus Library Config Loader - Could not find ", a, b)
            end
        end
    )
end
...
local function SaveCfg(Name)
    local Data = {}
    for i, v in pairs(MetheusLib.Flags) do
        if v.Save then
    ...
    writefile(MetheusLib.Folder .. "/" .. Name .. ".txt", tostring(HttpService:JSONEncode(Data)))
end
...
function MetheusLib:MakeNotification(NotificationConfig)
    spawn(
        function()
...
function MetheusLib:Init()
    if MetheusLib.SaveCfg then
        pcall(
            function()
                if isfile(MetheusLib.Folder .. "/" .. game.GameId .. ".txt") then
                    LoadCfg(readfile(MetheusLib.Folder .. "/" .. game.GameId .. ".txt"))
...
function MetheusLib:MakeWindow(WindowConfig)
    local FirstTab = true
    ...
    WindowConfig.Name = WindowConfig.Name or "Metheus Library"
    ...
    WindowConfig.IntroText = WindowConfig.IntroText or "Metheus Library"
    WindowConfig.CloseCallback = WindowConfig.CloseCallback or function()
        end
    WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
    WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://8834748103"
    WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://8834748103"
    MetheusLib.Folder = WindowConfig.ConfigFolder
    MetheusLib.SaveCfg = WindowConfig.SaveConfig
    ...
    function TabFunction:AddTab(TabConfig)
        ...
        local function GetElements(ItemParent)
            ...
            function ElementFunction:CreateLabel(Text)
                local LabelFrame =
                    AddThemeObject(
                    SetChildren(
                        SetProps(
            ...
            function ElementFunction:CreateParagraph(Text, Content)
                Text = Text or "Text"
            ...
            function ElementFunction:CreateButton(ButtonConfig)
                        ...
                        TweenService:Create(
                            ...
                            TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                            {
                                BackgroundColor3 = Color3.fromRGB(
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.R * 255 + 3,
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.G * 255 + 3,
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.B * 255 + 3
                                )
                            }
                        ):Play()
                    end
                ...
                AddConnection(
                    ...
                    function()
                        TweenService:Create(
                            ButtonFrame,
                            TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                            {BackgroundColor3 = MetheusLib.Themes[MetheusLib.SelectedTheme].Second}
                        ):Play()
                    end
                )
                ...
                AddConnection(
                    ...
                    function()
                        TweenService:Create(
                            ...
                            {
                                BackgroundColor3 = Color3.fromRGB(
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.R * 255 + 6,
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.G * 255 + 6,
                                    MetheusLib.Themes[MetheusLib.SelectedTheme].Second.B * 255 + 6
                                )
                            }
                        ):Play()
                    end
            ...
            function ElementFunction:CreateToggle(ToggleConfig)
                ...
                function Toggle:Set(Value)
                    ...
                    TweenService:Create(
                        ...
                        {BackgroundColor3 = Toggle.Value and ToggleConfig.Color or MetheusLib.Themes.Default.Divider}
                    ):Play()
                    TweenService:Create(
                        ToggleBox.Stroke,
                        TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                        {Color = Toggle.Value and ToggleConfig.Color or MetheusLib.Themes.Default.Stroke}
                    ):Play()
                    TweenService:Create(
                        ToggleBox.Ico,
                        TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                ...
                if ToggleConfig.Flag then
                    MetheusLib.Flags[ToggleConfig.Flag] = Toggle
                end
                return Toggle
            end
            function ElementFunction:CreateSlider(SliderConfig)
                ...
                if SliderConfig.Flag then
                    MetheusLib.Flags[SliderConfig.Flag] = Slider
                end
                return Slider
            end
            function ElementFunction:CreateDropdown(DropdownConfig)
                ...
                if DropdownConfig.Flag then
                    MetheusLib.Flags[DropdownConfig.Flag] = Dropdown
                end
                return Dropdown
            end
            function ElementFunction:CreateBind(BindConfig)
                ...
                if BindConfig.Flag then
                    MetheusLib.Flags[BindConfig.Flag] = Bind
                end
                return Bind
            end
            function ElementFunction:CreateTextbox(TextboxConfig)
            ...
            function ElementFunction:CreateColorpicker(ColorpickerConfig)
                ...
                if ColorpickerConfig.Flag then
                    MetheusLib.Flags[ColorpickerConfig.Flag] = Colorpicker
                end
                return Colorpicker
            end
            return ElementFunction
        ...
        function ElementFunction:CreateSection(SectionConfig)
