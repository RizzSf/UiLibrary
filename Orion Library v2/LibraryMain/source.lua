...
function OrionLib:MakeWindow(WindowConfig)
    ...
    SearchBox.FocusLost:Connect(function()
        ...
        for _, Tab in pairs(TabHolder:GetChildren()) do
            if Tab:IsA("TextButton") and Tab.Title.Text:lower():find(searchText) then
                OrionLib:MakeNotification({
                    Name = "Search Result",
                    Content = "Found: " .. Tab.Title.Text,
                    Time = 5
                })
            end
        end
    ...
    return TabFrame
        ...
        local function GetElements(ItemParent)
            ...
            function ElementFunction:AddImageLabel(Image)
                local ImageLabelFrame =
                    AddThemeObject(
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5),
                ...
                local ImageLabelFunction = {}
                function ImageLabelFunction:Set(NewImage)
                    ImageLabelFrame.Content.Image = NewImage
                end
                return ImageLabelFunction
            end
            ...
            function ElementFunction:AddImageParagraph(Text, Content, ImageId, ImageSize)
                Text = Text or "Text"
                Content = Content or "Content"
                ImageId = ImageId or ""
                ImageSize = ImageSize or 50
            
                local ImageParagraphFrame =
                    AddThemeObject(
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5),
                        ...
                        ),
                        {
                            ...
                            AddThemeObject(
                                SetProps(
                                    ...
                                    {
                                        Size = UDim2.new(1, -12, 0, 14),
                                        Position = UDim2.new(0, 12, 0, ImageId and (ImageSize + 10) or 10),
                                        Font = Enum.Font.GothamBold,
                                        Name = "Title"
                                    }
                                ),
                            ...
                            AddThemeObject(
                                SetProps(
                                    ...
                                    {
                                        Size = UDim2.new(1, -24, 0, 0),
                                        Position = UDim2.new(0, 12, 0, ImageId and (ImageSize + 26) or 26),
                                        Font = Enum.Font.GothamSemibold,
                                        Name = "Content",
                                        TextWrapped = true
                                    }
                ...
                AddConnection(
                    ImageParagraphFrame.Content:GetPropertyChangedSignal("Text"),
                    function()
                        local textHeight = ImageParagraphFrame.Content.TextBounds.Y
                        local imageHeight = ImageId and (ImageSize + 10) or 0
                        ImageParagraphFrame.Content.Size = UDim2.new(1, -24, 0, textHeight)
                        ImageParagraphFrame.Size = UDim2.new(1, 0, 0, textHeight + imageHeight + 35)
                    end
                )
            
                ImageParagraphFrame.Content.Text = Content
            
                local ImageParagraphFunction = {}
                function ImageParagraphFunction:Set(ToChange, NewImageId, NewImageSize)
                    if ToChange then
                        ImageParagraphFrame.Content.Text = ToChange
                    end
                    if NewImageId then
                        ImageParagraphFrame.ImageLabel.Image = "rbxassetid://" .. NewImageId
                    end
                    if NewImageSize then
                        ImageParagraphFrame.ImageLabel.Size = UDim2.new(0, NewImageSize, 0, NewImageSize)
                        ImageParagraphFrame.ImageLabel.Position = UDim2.new(0.5, -NewImageSize / 2, 0, 5)
                    end
                end
    ...
    OrionLib:MakeNotification(
        {
            Name = "Orion Library [v2]",
            Content = "This is New Orion Library [Made by Rizz]",
            Time = 5
        }
    )
