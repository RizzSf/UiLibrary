...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet('https://raw.githubusercontent.com/RizzSf/UiLibrary/refs/heads/main/Orion%20Library%20v2/LibraryMain/source.lua'))()
```
...
```lua
Tab:AddImageLabel("rbxassetid://4483345998")
```

### Set Image
```lua
ImageLabel:Set("rbxassetid://4483345998")
```
